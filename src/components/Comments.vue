    ...
    <div class="comments">
        ...
        <div class="reply">
            ...
            <input 
                ...
                maxlength="250"
                required
                @keyup.enter="submitComment(current_post)"
            />
            <button class="reply--button" @click.prevent="submitComment(current_post)">Send</button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            submitComment(postId) {
                if(this.reply != '') {
                    this.$emit('submit-comment', this.reply, postId);
                    this.reply = '';
                }
            }
        },
        props: ['comments', 'current_user', 'current_post', 'comments_wrapper_classes']
    }
</script>
